...
export default function Example({ menuText }) {
  return (
    <Menu as='div' className='relative inline-block text-left mt-0.5'>
      ...
      >
        <Menu.Items className='absolute left-0 w-56 mt-7 border-t-4 border-yellow-999 bg-white rounded-b-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none'>
